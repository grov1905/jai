        ...
        try:
           ...
           # logger.info(f"historial: {history} ")
            if not filtered:
                ...
                "y termina siempre preguntando como te puedo ayudar o que apoyo neecesistas de mi, y termina con un '¡Espero haberte sido de ayuda! Si tienes alguna otra pregunta, no dudes en contactarme.' minimo una palabra y maximo en 50 palabras"
                )
            ...
            system_message = (
                ...
                "Responde con amabilidad y usa solo los datos del contexto e historial, minimo una palabra y maximo en 100 palabras. y termina siempre preguntando como te puedo ayudar o que apoyo neecesistas de mi"
                "contexto: "
                f"\n{context}\n"
